/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4871e4d9a6f059bbac862710086552d1)
// Runtime types generated with workerd@1.20260504.1 2026-05-07 global_fetch_strictly_public
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "OrderLiveCoordinator";
	}
	interface DevEnv {
		ASSET_BUCKET: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
		ORDER_LIVE_COORDINATOR: DurableObjectNamespace<import("./src/worker").OrderLiveCoordinator>;
	}
	interface ProdEnv {
		ASSET_BUCKET: R2Bucket;
		DB: D1Database;
